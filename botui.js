...
function bot_ui_ini() {
    ...
    botui.message.add({ delay: 800, content: "Hi, 你好👋" })
        .then(function() {
            botui.message.add({ delay: 1100, content: "这里是 K_Q's Love" })
                .then(function() {
                    botui.message.add({ delay: 1100, content: "一个记录我们恋爱日常的小博客~" })
                        .then(function() {
                            botui.action.button({
                                    delay: 1600,
                                    action: [
    ...
    var sure = function() {
            botui.message.add({ delay: 800, content: "感谢您百忙之中来看我们秀恩爱！ 🌹🌹🌹" })
                .then(function() { secondpart() })
        },
        end = function() { botui.message.add({ delay: 800, content: "![...](https://cdn.jsdelivr.net/gh/XXXZhy/Blog_Image/images/黄狗白眼.webp)" }) },
        secondpart = function() {
            botui.message.add({ delay: 1500, content: "我们现就读于天津理工大学" })
                .then(function() {
                    botui.message.add({ delay: 1500, content: "男生是技术宅" })
                        .then(function() {
                            botui.message.add({ delay: 1200, content: "女生是美少女" })
                                .then(function() {
                                    botui.action.button({ delay: 1100, action: [{ text: "你们有什么目标吗？🤔", value: "why-mashiro" }] })
                                        .then(function(a) { thirdpart() })
                                })
                        })
                })
        ...
        thirdpart = function() {
            botui.message.add({ delay: 1e3, content: "小目标是一起考北京的研究生～" })
                .then(function() {
                    botui.message.add({ delay: 1500, content: "大目标当然是结婚生娃娃啦～" })
                        .then(function() {
                            botui.action.button({ delay: 1500, action: [{ text: "你们有什么共同的爱好吗？👊", value: "why-cat" }] })
                                .then(function(a) { fourthpart() })
                        })
                })
        },
        fourthpart = function() {
            botui.message.add({ delay: 1e3, content: "我们喜欢一起看电影🎥" })
                .then(function() {
                    botui.message.add({ delay: 1100, content: "当然最大的共同爱好还是吃吃吃啦🍔~" })
                        .then(function() {
                            botui.action.button({ delay: 1500, action: [{ text: "能加个联系方式吗？🙋", value: "why-domain" }] })
                                .then(function(a) { fifthpart() })
                        })
                })
        },
        fifthpart = function() {
            botui.message.add({ delay: 1e3, content: "当然可以啦~" })
                .then(function() {
                    botui.message.add({ delay: 1600, content: "您可以根据下方的联系方式进行添加!" })
